                            ...
                            {expandedId === log._id && (
                                <div className="px-8 pb-8 pt-2 space-y-6 animate-in slide-in-from-top-2">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="space-y-4">
                                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block">Faculty Advisor Feedback</label>
                                            {log.comment?.text ? (
                                                ...
                                                <div className="p-8 border-2 border-dashed border-slate-100 rounded-3xl text-center">
                                                    <p className="text-xs text-slate-300 italic font-medium">Waiting for faculty advisor review...</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
